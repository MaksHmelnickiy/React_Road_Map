...
// ⁡⁢⁣⁣fetch⁡ предоставляет более простой и современный интерфейс для сетевых запросов, чем использование более ⁡⁢⁣⁢старых⁡ технологий, таких как ⁡⁢⁣⁣XMLHttpRequest⁡.
// Он также позволяет выполнять различные типы HTTP-запросов, такие как ⁡⁣⁣⁢GET, POST, PUT, DELETE⁡ и другие.
// пример
