...
// ⁡⁣⁢⁣Применение⁡: useMemo - это хук, который ⁡⁣⁣⁢применяется внутри функциональных компонентов⁡. Он ⁡⁢⁣⁣мемоизирует⁡ результат выполнения функции.
// ⁡⁣⁢⁣Цель⁡: Основная цель useMemo - ⁡⁣⁣⁢кэширование вычисленных значений⁡, чтобы избежать лишних вычислений при повторных рендерах компонента.
// ⁡⁣⁢⁣Использование⁡: Вы используете useMemo внутри компонента для ⁡⁣⁣⁢мемоизации определенных вычислений⁡. Вы передаете функцию и массив зависимостей, 
// и ⁡⁢⁣⁣useMemo кэширует результат⁡ этой функции, пока зависимости не изменятся.
