...
// Это значит, что ⁡⁣⁣⁢при каждом рендере⁡ компонента, функция, созданная с помощью useCallback, ⁡⁢⁣⁢не будет⁡ ⁡⁢⁣⁣создаваться заново⁡⁡, 
// ⁡⁣⁣⁢если её зависимости не изменились⁡.
...
// Хотя ⁡⁣⁣⁢в данном примере⁡ использование⁡⁢⁣⁣ useCallback⁡ ⁡⁣⁣⁢не приносит большой выгоды⁡ (потому что ⁡⁢⁣⁢нет⁡ ⁡⁣⁣⁢дочерних компонентов или эффектов 
// сайд-эффектов, зависящих от этой функции⁡), 
// оно демонстрирует основную концепцию работы этого хука. В более сложных сценариях, 
// где функции передаются в дочерние компоненты или используются в других хуках, 
